        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            <button className="relative p-3 text-white/70 hover:text-white hover:bg-white/10 rounded-2xl transition-all duration-300 group">
              ...
              <span className="absolute -top-1 -right-1 h-5 w-5 bg-gradient-to-r from-pink-500 to-red-500 rounded-full text-xs text-white flex items-center justify-center">
                3
              </span>
            </button>
            <div className="flex items-center space-x-3 ml-4 bg-white/10 backdrop-blur-xl rounded-2xl px-4 py-2 border border-white/20 hover:bg-white/20 transition-all duration-300 cursor-pointer group">
              <div className="hidden md:block text-right">
                <p className="text-white font-semibold">Rinae Tshibubudze </p>
                <p className="text-white/60 text-xs">System Administrator </p>
              </div>
              <div className="relative">
                <div className="h-12 w-12 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-all duration-300">
                ...
                <ChevronDown className="h-4 w-4 text-white/60 group-hover:text-white/80 transition-all" />
              </div>
            </div>
          </div>
        </div>
